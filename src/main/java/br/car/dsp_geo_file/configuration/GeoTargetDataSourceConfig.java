...
/**
 * Geo target DataSource — {@code dsp-geoserver-db}, the same base the download WFS reads.
 * Exporting from here is what makes the pre-generated file equivalent to the WFS answer.
 */
@Configuration
